...
typedef see_uintptr_t           see_simple_type_t;

#define SEE_TYPE_NULL              ((see_type_t)0x00)
#define SEE_TYPE_INTERNAL_INT      ((see_type_t)0x01)
#define SEE_TYPE_INTERNAL_SYMBOL   ((see_type_t)0x02)
#define SEE_TYPE_INTERNAL_TOTAL    0x08
#define SEE_TYPE_DUMMY             ((see_type_t)0x08)

#define SEE_TYPE_USER_DEFINE_START 0x09

#define SEE_TYPE_EXTERNAL          ((see_type_t)0xff)
#define SEE_TYPE_TOTAL             0x100
...
/* 010   -- Internal symbol       */
/* Other -- Undefined             */
#define SEE_TYPE_MASK                  0x7
#define SEE_IS_INTERNAL_INT(obj)       ((see_uintptr_t)(obj) & 1)
#define SEE_IS_INTERNAL_SYMBOL(obj)    (((see_uintptr_t)(obj) & 0x7) == SEE_TYPE_INTERNAL_SYMBOL)
#define SEE_IS_INTERNAL_CLOSURE(obj)   (((see_uintptr_t)(obj) & 0x7) == SEE_TYPE_INTERNAL_CLOSURE)
#define SEE_INTERNAL_INT_BOX(num)      ((see_object_t)(((see_uintptr_t)(num) << 1) | 1))
#define SEE_INTERNAL_INT_UNBOX(obj)    ((see_intptr_t)(obj) >> 1)
#define SEE_INTERNAL_SYMBOL_BOX(id)    ((see_object_t)(((see_uintptr_t)(id) << 3) | (see_uintptr_t)SEE_TYPE_INTERNAL_SYMBOL))
...
static char __static_assumption_for_gc_header_size[sizeof(see_gc_header_s) % 8 == 0 ? 0 : -1] __attribute__((used));
...
extern see_type_t see_types[SEE_TYPE_TOTAL];
